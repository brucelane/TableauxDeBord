...
using TableauxDeBord.Data;
using TableauxDeBord.Common;
...
namespace TableauxDeBord
{
    ...
    public sealed partial class HubPage : Page
    {
        ...
        public HubPage()
        {
            ...
            Etat.Text = navigateur.Source.ToString();
            navigateur.Source = new Uri("ms-appx-web:///default.html");
        }
